...
{
    WebDriver driver;
    private By PickDataList=By.xpath("//select[contains(@class,'pickData')]//option");
    ...
    private By ReturnDataList= By.xpath("//select[contains(@class,'pickListResult')]//option");
    ...
    {
        driver.findElement(PickDataList).click();
    ...
    {
        driver.findElement(ReturnDataList).click();
