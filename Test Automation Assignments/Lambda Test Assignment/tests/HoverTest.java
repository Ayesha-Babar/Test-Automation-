...
public class HoverTest extends BaseTest
{
    ...
    @Test(priority = 1,groups={"smoke","sanity"},description = "Verify that hover effects are applied as expected and test their interactions triggered by hovering")
    ...
    @Test(priority = 2,groups={"smoke","sanity"},description = "Verify that hover effects are applied as expected and test their interactions triggered by hovering")
